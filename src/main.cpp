...
const string strMessageMagic = "DoraCoin Signed Message:\n";
...
static const int64 nTargetTimespan = .35 * 24 * 60 * 60; // DoraCoin: .35 days
static const int64 nTargetSpacing = 120; // DoraCoin: 120 seconds
                                 ...
                                 const CBlockIndex* pindexBlock, bool fBlock, bool fMiner, bool fStrictPayToScriptHash)
{
    ...
    // fMiner is true when called from the internal doracoin miner
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "DoraCoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0xb2caf0893ce365f3d18be67d8c641f683e65cad7cbe7737f7db01b9a867e0ff1");
    }
	...
	// vMerkleTree: 5a2e19825b
        ...
        // Genesis block
        const char* pszTimestamp = "June 25th 2017 - NYTimes headline --Can Trump Destroy Obamas legacy";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1498406711;//modifed by AF
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 386402991; //modified by AF

        if (fTestNet)
        {
            block.nTime    = 1498406709; // modified by AF
            block.nNonce   = 386558207; //modified by AF
        }
        ...
        assert(block.hashMerkleRoot == uint256("0x151d483bc51ba3775a15cd473392687dc1cbf3edab6cb533ea32f97c7c15a695"));

        // If genesis block hash does not match, then generate new genesis hash.
         // changed if from false to true AF
